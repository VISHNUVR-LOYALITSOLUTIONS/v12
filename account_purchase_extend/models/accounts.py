...
class AccountInvoiceLine(models.Model):
    ...
    @api.depends('price_unit', 'discount', 'invoice_line_tax_ids', 'quantity', 'product_id', 'invoice_id.currency_id',
                 'invoice_id.partner_id', 'invoice_id.company_id', 'invoice_id.discount','invoice_id.ks_global_discount_type','inclusive')
    def calculate_calc_residual(self):
        ...
        if self.invoice_id.type in ['in_invoice','in_refund']:
            ...
            if self.invoice_id.ks_global_discount_type == "percent":
                spl_dis = ((included_amount * self.invoice_id.discount) / 100)
            if self.invoice_id.ks_global_discount_type == "amount":
                total_amount = 0
    ...
    def _onchange_product_id(self):
        ...
        self.hsn = self.product_id.l10n_in_hsn_code
...
class AccountInvoice(models.Model):
    ...
    # @api.onchange('ks_global_discount_type', 'discount', )
    ...
    #              'discount_amt','type','round_off_value','round_off_operation','freight','inclusive')
    ...
    #
    #             # disc_id = ir_values.get_default('res.config.settings', 'discount_account')
    #             move_line_dict = {
    #                 'type': 'dest',
    ...
    #         if self.round_off_value != 0.0 :
    #             rounded_total =0
    #             if self.round_off_operation == 'plus':
    #                 acc_id = ir_values.get_default('res.config.settings', 'round_off_account_expense')
    #                 rounded_total = self.rounded_total
    #             if self.round_off_operation == 'minus':
    #                 acc_id = ir_values.get_default('res.config.settings', 'round_off_account_income')
    #                 rounded_total = self.rounded_total*-1
    #
    #             move_line_dict = {
    #                 'type': 'dest',
    #                 'name': 'Round off',
    #                 'price_unit': self.rounded_total,
    ...
    #             res.append(move_line_dict)
    #         if self.freight != 0.0:
    #             acc_id = ir_values.get_default('res.config.settings', 'freight_account')
    #             move_line_dict = {
    #                 'type': 'dest',
    #                 'name': 'Freight Charge',
